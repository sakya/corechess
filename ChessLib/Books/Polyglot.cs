...
namespace ChessLib.Books
{
    ...
    public class Polyglot : IBook
    {
        ...
        /// <summary>
        /// Get best moves for the given FEN string in the book
        /// </summary>
        ...
        /// <summary>
        /// Get the hash key corresponding to the given FEN string
        /// </summary>
        /// <param name="fenString">The FEN string</param>
        /// <returns></returns>
        private static string GetHashFromFen(string fenString)
        {
        ...
        /// <summary>
        /// Get best moves for the given hash key in the book
        /// </summary>
            ...
            using (var fs = new FileStream(FileName, FileMode.Open, FileAccess.Read, FileShare.Read)) {
                ...
                while (true) {
                    ...
                    if (!resMoves.Contains(next.Move)) {
                        res.Add(next);
                        resMoves.Add(next.Move);
                    }
                }
            }
            return res.OrderByDescending(m => m.Weight).ToList<IBookEntry>();
        } // GetMoves
